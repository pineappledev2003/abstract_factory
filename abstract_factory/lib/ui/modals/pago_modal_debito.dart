...
class PagoModalDebito extends StatefulWidget {
  final Debito debito;
  const PagoModalDebito({super.key, required this.debito});

  @override
  State<PagoModalDebito> createState() => _PagoModalDebitoState();
}

class _PagoModalDebitoState extends State<PagoModalDebito> {
  String tipo = "";
  String id = "";
  double limite = 0.0;
  ...
  void initState() {
    ...
    tipo = widget.debito.obtenerTipoTarjeta;
    id = widget.debito.obtenerNumeroTarjeta;
    limite = widget.debito.obtenerDisponible;
  }
